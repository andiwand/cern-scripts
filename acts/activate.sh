...
. ~/cern/install/root/6.32.06/bin/thisroot.sh
. ~/cern/install/DD4hep/01-30/bin/thisdd4hep.sh
...
# root include path
export ROOT_INCLUDE_PATH="${ROOT_INCLUDE_PATH}":~/cern/install/podio/01-01/include
