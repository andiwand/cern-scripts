...
parser.add_argument("e1GeV_finding_perf", type=Path)
parser.add_argument("e10GeV_finding_perf", type=Path)
...
labels = ["e $p_T=1$ GeV", "e $p_T=10$ GeV", "$\\mu$ $p_T=10$ GeV"]
finding_perf = [
    args.e1GeV_finding_perf,
    args.e10GeV_finding_perf,
...
for i, label, perf in zip(range(3), labels, finding_perf):
