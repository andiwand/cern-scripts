#!/bin/bash
# Build and run the RZ unit tests of acts-rz-main (ACTS main + RZ) in the release's environment
source /home/astefl/scripts/athena/acts-athena-ci/rz-track-finder/rz2env.sh >/dev/null 2>&1
BUILD=/home/astefl/source/acts/acts-athena-ci/acts-rz-main-unittest-build
...
cmake -S /home/astefl/source/acts/acts-athena-ci/acts-rz-main -B $BUILD -GNinja \
