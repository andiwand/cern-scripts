...
Reco_tf.py \
  ...
  --steering 'doRAWtoALL' \
  --postExec "cfg.getEventAlgo('ActsStripSpacePointFormationAlg').SpacePointFormationTool.StripGapParameter=0.0;cfg.getEventAlgo('ActsStripSpacePointFormationAlg').SpacePointFormationTool.ScalarMath=True" \
